...
import { calculateEffectiveTimeAtDestinationMinutes } from '../ranking/effective-time.ts';
import { EvalContractError, type NarrativeQualityAuthoringContext } from './dataset.ts';

export const SYNTHETIC_EVAL_FIXTURE_VERSION = 'narrative-quality-synthetic-fixtures-v2';
...
const FIXTURES: readonly SyntheticFixtureDefinition[] = [
  {
    ...
    fixtureBuilder: 'grounded-option-prague-v2',
    destinationCode: 'PRG',
  ...
  },
  {
    ...
    fixtureBuilder: 'grounded-option-vienna-eur-v2',
    destinationCode: 'VIE',
  ...
  },
  {
    ...
    fixtureBuilder: 'grounded-option-budapest-unknown-v2',
    destinationCode: 'BUD',
  ...
  },
  {
    ...
    fixtureBuilder: 'grounded-option-berlin-adversarial-v2',
    destinationCode: 'BER',
...
/** Authoring schema omits times; v2 freezes the documented synthetic limits. */
